...
#define MSGT_UART_WRITE_SIDE 47
#define MSGT_UART_WRITE_FRONT 48
#define MSGT_UART_WRITE_SIDE2 49
#define MSGT_ADC_DATA 50
#define MSGT_I2C_READ 52
#define I2C_MESSAGE_LENGTH 10
#define SENSOR_NUMBER 3
#define AVERAGE 8
#define I2C_READ_ERROR 53
#define MSGT_SENSORS 51
